...
class YatayBody extends StatefulWidget {
  final Pokemon pokemon;
  final String imge;

  const YatayBody({Key key, this.pokemon, this.imge});

  @override
  _YatayBodyState createState() => _YatayBodyState();
}

class _YatayBodyState extends State<YatayBody> {
  @override
        ...
        children: [
          Expanded(
            ...
            child: Hero(
              ...
              child: Container(
                width: 200,
                child: Image.network(widget.imge, fit: BoxFit.fill),
              ),
            ),
          ),
          Expanded(
